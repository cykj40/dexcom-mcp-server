...
/** biome-ignore-all lint/suspicious/noConsole: CLI OAuth helper prints setup instructions to stdout */
...
function loadDotEnv(): Record<string, string> {
  ...
  if (!existsSync(envPath)) {
    console.error(
      '❌ No .env file found. Copy .env.example to .env and fill in your client credentials first.',
    )
    process.exit(1)
  }
...
const BASE_URL = API_ENV === 'sandbox' ? 'https://sandbox-api.dexcom.com' : 'https://api.dexcom.com'
